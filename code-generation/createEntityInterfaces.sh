# It create interface module for client-NOT-USED projects.
#
...
echo "//!!!!!!!!!!!!!!!!!! GENERATED BY ${APP} - DON'T CHANGE IT !!!!!!!!!!!!!!!!!!"
# add here imports for custom types
#echo "import { ConfigType, TraderState, ExchangeStatus } from '@app/client-lib';"
echo "import { ConfigType } from './model/config.model';"
echo "import { ExchangeStatus, TraderState } from './client-lib.model';"
